...
mod tree_sitter_indexer {
    ...
    mod typescript_file_indexing {
        ...
        async fn should_extract_typescript_symbols_correctly() {
            ...
            assert!(symbols
                .iter()
                .any(|s| s.name == "sample.ts" && s.symbol_type == SymbolType::Filename));
            assert!(symbols
                .iter()
                .any(|s| s.name == "fixtures" && s.symbol_type == SymbolType::Dirname));

            // Tree-sitter function queries should work well
            assert!(symbols
                .iter()
                .any(|s| s.name == "formatUserName" && s.symbol_type == SymbolType::Function));
            assert!(symbols
                .iter()
                .any(|s| s.name == "addUser" && s.symbol_type == SymbolType::Function));
            assert!(symbols
                .iter()
                .any(|s| s.name == "findUserById" && s.symbol_type == SymbolType::Function));
            assert!(symbols
                .iter()
                .any(|s| s.name == "constructor" && s.symbol_type == SymbolType::Function));
            assert!(symbols
                .iter()
                .any(|s| s.name == "userCount" && s.symbol_type == SymbolType::Function));
            assert!(symbols
                .iter()
                .any(|s| s.name == "internalHelper" && s.symbol_type == SymbolType::Function));
    ...
    mod javascript_file_indexing {
        ...
        async fn should_extract_javascript_symbols_correctly() {
            ...
            assert!(symbols
                .iter()
                .any(|s| s.name == "createCalculator" && s.symbol_type == SymbolType::Function));
            assert!(symbols
                .iter()
                .any(|s| s.name == "constructor" && s.symbol_type == SymbolType::Function));
            assert!(symbols
            ...
            assert!(symbols
                .iter()
                .any(|s| s.name == "multiply" && s.symbol_type == SymbolType::Function));
            assert!(symbols
                .iter()
                .any(|s| s.name == "getValue" && s.symbol_type == SymbolType::Function));
            assert!(symbols
                .iter()
    ...
    mod file_caching {
        ...
        async fn should_clear_cache_when_requested() {
            ...
            assert!(!indexer.get_symbols_by_file(&file_path).is_empty());
