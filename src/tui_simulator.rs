use crate::{
    backend::{SearchBackend, BackendEvent, UserCommand},
    tui_state::{TuiState, TuiInput, TuiAction},
    types::{SearchResult, SearchMode},
};
...
impl TuiSimulator {
    ...
    pub fn new_without_backend_thread(verbose: bool, respect_gitignore: bool) -> Result<(Self, SearchBackend)> {
    ...
    pub fn wait_for_event_timeout(&mut self, 
                                  timeout: Duration) -> Result<Option<BackendEvent>> {
