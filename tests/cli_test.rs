...
"#;
    ...
    mod symbol_searching {
        ...
        fn should_find_symbols_in_test_directory() {
            ...
            assert!(stdout.contains("Indexing") || stdout.contains("Found") || stdout.contains("TestClass"));
        }
    ...
    mod error_handling {
        ...
        fn should_show_no_results_message_when_nothing_found() {
            ...
            assert!(stdout.contains("No results") || stdout.contains("0 symbols") || stdout.contains("found"));
        }
    }
    ...
    mod performance_and_reliability {
        ...
        fn should_complete_within_reasonable_time_for_small_projects() {
            ...
            let (exit_code, _stdout, _stderr) = run_cli(&[
                "test",
                "--directory", 
                test_dir.to_str().unwrap(),
            ]);
